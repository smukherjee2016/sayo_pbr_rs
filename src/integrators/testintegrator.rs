        ...
        for i in 0..(film.height * film.width) {
            ...
            for _j in 0..samples_count {
                for _k in 0..bounces_count {
                    ...
                    let y;
                    let z;
                    if ray.d.x > 0.0 { x = ray.d.x; } else { x = -ray.d.x; }
                    if ray.d.y > 0.0 { y = ray.d.y; } else { y = -ray.d.y; }
                    if ray.d.z > 0.0 { z = ray.d.z; } else { z = -ray.d.z; }
            ...
            if (position_in_film as f32 / (film.height * film.width) as f32) * 100.0 % 1.0 == 0.0 {
                info!("Finished {} percent.", ((position_in_film as f32 / (film.height * film.width) as f32) * 100.0) as i32);
            }
        }
